...
2. Gender-Wise Sales Analysis  
     Men vs Women contribution using pie chart
     Shows Women contribute 64% of total sales

3. Top 5 Performing States
     State-wise revenue ranking
     Identifies Maharashtra, Karnataka, and Uttar Pradesh as top markets

4. Order Status Monitoring
     Delivered, Cancelled, Returned, Refunded distribution
     Delivery success rate: 92%

5. Age Group vs Gender Insights
     Customer segmentation into Adult, Senior, and Teenager
     Helps target marketing strategies

6. Sales Channel Performance
     Platform-wise sales share (Amazon, Flipkart, Myntra, Meesho, Nalli, Others)
